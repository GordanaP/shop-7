...
<x-layouts.master>
    ...
    @section('scripts')
        ...
        <script>
            ...
            var userFavoritesUrl = @json(route('users.favorites.list', Auth::user()));
        ...
        <script>
            $(document).on('click', '#unfavoriteProductBtn', function() {
                ...
                var userUnfavoriteProductUrl = '/users/'+userId+'/products/'+ productSlug +'/favorites'

                $.ajax({
                    url: userUnfavoriteProductUrl,
                    type: 'PUT',
                })
